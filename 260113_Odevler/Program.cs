namespace _260113_Odevler
{
    internal class Program
    {
        static void Main(string[] args)
        {
             ...
             * 5- 1. 2. ve 3. sayının toplamının 4.sayıya bölümü
             *
             */
            ...
            double toplam=(double)(sayi1+sayi2+sayi3+sayi4);
            double carpTopla = (double)(sayi1 * sayi2 / toplam);
            double toplam2 = (double)(sayi1 + sayi2);
            double cikart = (double)(sayi3 - sayi4);
            double sonuc1 = (double)(toplam2 / cikart);
            double toplam3 = (double)(sayi1 + sayi2 + sayi3);
